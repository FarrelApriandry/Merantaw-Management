...
export default function Sidebar({ isOpen, toggleSidebar }) {
    ...
    // handle current path supaya gak bentrok SSR
        ...
        <div className="mt-3">
            ...
            <div key={space.id}>
                ...
                {openSpaces[space.id] && isOpen && (
                    ...
                    >
                    <NavItem label="Dashboard Project" href={`/dashboard/${space.id}/projects`} isOpen={isOpen} currentPath={currentPath} />
                    <NavItem label="Task" href={`/dashboard/${space.id}/tasks`} isOpen={isOpen} currentPath={currentPath} />
                    <NavItem label="Discussion" href={`/dashboard/${space.id}/discussion`} isOpen={isOpen} currentPath={currentPath} />
                    </motion.div>
                )}
                </AnimatePresence>
            </div>
